...
public class MAtProcessorFrequent extends MAtProcessorModel
{
	...
	protected void doProcess()
	{
		...
		conversionComplete(36, Version170Helper.getNameAt(x, y - 1, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		
		//setValueLegacyIntIndexes(
		//	37, y >= 2 && y < MAT_HARD_LIMITS.USE_MAX_HEIGHT_LIMIT
		//		? Version170Helper.getNameAt(x, y - 2, z) : MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS);
		conversionComplete(37, Version170Helper.getNameAt(x, y - 2, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		...
		conversionComplete(42, MAtAccessor_NetMinecraftEntity.getInstance().isJumping(player) ? 1 : 0);
		
		conversionComplete(43, (int) (player.fallDistance * 1000));
		
		conversionComplete(44, MAtAccessor_NetMinecraftEntity.getInstance().isInWeb(player) ? 1 : 0);
		...
		conversionComplete(94, Version170Helper.getNameAt(x, y, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		
		///setValueLegacyIntIndexes(
		///	95, y >= 0 && y < mod().util().getWorldHeight() - 1
		///		? Version170Helper.getNameAt(x, y + 1, z) : MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS);
		conversionComplete(95, Version170Helper.getNameAt(x, y + 1, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
