...
public class M__cb_column extends ModuleProcessor implements Module
{
	...
	protected void doProcess()
	{
		...
		setValue("y-1", Version170Helper.getNameAt(x, y - 1, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		setValue("y-2", Version170Helper.getNameAt(x, y - 2, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		setValue("y0", Version170Helper.getNameAt(x, y + 0, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
		setValue("y1", Version170Helper.getNameAt(x, y + 1, z, MAT_HARD_LIMITS.NO_BLOCK_OUT_OF_BOUNDS));
