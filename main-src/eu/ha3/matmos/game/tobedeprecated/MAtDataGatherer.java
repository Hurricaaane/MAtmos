...
import eu.ha3.matmos.game.data.abstractions.scanner.MAtScanVolumetricModel;
...
public class MAtDataGatherer implements Collector, Processor
{
	...
	public void load()
	{
		...
		this.configVarsProcessor = new UNSUPPORTED_MAtProcessorCVARS(this.mod, this.data, CONFIGVARS, null);
